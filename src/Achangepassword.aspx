<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="Achangepassword.aspx.cs" Inherits="Assignment.Achangepassword" %>
					...
					<table class="auto-style3" align="center">
                        <tr>
                            ...
                            <td class="auto-style8">
                                <asp:TextBox ID="TextBoxOldPassword" runat="server" Width="200px" OnTextChanged="TextBoxOldPassword_TextChanged" TextMode="Password"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="auto-style6">
                                <asp:TextBox ID="TextBoxNewPassword" runat="server" Width="200px" OnTextChanged="TextBoxNewPassword_TextChanged" TextMode="Password"></asp:TextBox>
                            </td>
