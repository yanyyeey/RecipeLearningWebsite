<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="Acommunity.aspx.cs" Inherits="Assignment.admin.Acommunity" %>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="heading-title text-center">
						<h1>Community Manage Panel</h1>
					</div>
					<table class="w-100">
                            <tr>
                                <td class="auto-style2">&nbsp;</td>
                                <td class="auto-style3">
                                    <asp:Label ID="Label1" runat="server" Text="Discussion ID:" Font-Bold="True"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="auto-style2">&nbsp;</td>
                                <td class="auto-style3">
                                    <asp:Label ID="Label2" runat="server" Text="Discussion Title:" Font-Bold="True"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="auto-style2">&nbsp;</td>
                                <td class="auto-style3">
                                    <asp:Label ID="Label3" runat="server" Text="Discussion DateTime:" Font-Bold="True"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style5">
                                    <asp:Label ID="Label4" runat="server" Text="Discussion Text:" Font-Bold="True"></asp:Label>
                                </td>
                            ...
                            <tr>
                                <td class="auto-style4"></td>
                                <td class="auto-style5">
                                    <asp:Label ID="Label5" runat="server" Text="Discussion Image:" Font-Bold="True"></asp:Label>
                                    </td>
                                <td class="auto-style6">
                                    <br />
