<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="Aregister.aspx.cs" Inherits="Assignment.admin.Aregister" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="contact-box">
        <div class="container text-center" style="width: 83%">
            <div class="row">
				<div class="form-group">
					<table class="auto-style3" align="center">
                        <tr>
                            <td class="auto-style13">
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="#FF9933" NavigateUrl="~/Adashboard.aspx" Width="200px">&lt; Manage User</asp:HyperLink>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="auto-style16">
                                ...
                                <br />
                                <asp:CheckBox ID="CheckBoxPassword" runat="server" AutoPostBack="True" OnCheckedChanged="CheckBoxPassword_CheckedChanged" Text="Show Password" CausesValidation="True" />
                            </td>
                            <td class="auto-style14">
                        ...
                        <tr>
                            ...
                            <td class="auto-style16">
                                ...
                                <br />
                                <asp:CheckBox ID="CheckBoxConfirmPassword" runat="server" AutoPostBack="True" OnCheckedChanged="CheckBoxConfirmPassword_CheckedChanged" Text="Show Password" CausesValidation="True" />
                            </td>
                            <td class="auto-style14">
                        ...
                        <tr>
                            ...
                            <td class="auto-style17">
                                &nbsp;<asp:Button ID="ButtonAddAdmin" runat="server" OnClick="ButtonAddAdmin_Click" Text="Add Admin" BackColor="#FFDE59" BorderStyle="None" CssClass="mytooltip" Height="50px" Width="120px" />
                            </td>
